...
export function NamesOfGodGrid() {
  ...
  return (
    <div className="min-h-screen bg-transparent sm:p-6 md:p-8">
      <div className="mx-auto max-w-7xl">
        <motion.div
          layout
          className="grid auto-rows-fr grid-cols-2 gap-3 sm:grid-cols-2 sm:gap-4 md:grid-cols-3 md:gap-5 lg:grid-cols-4 lg:gap-6"
        >
          {data.map((name, index) => (
            <NamesOfGodCard
              key={index}
