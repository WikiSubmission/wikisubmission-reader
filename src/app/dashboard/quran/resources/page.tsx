    ...
    <ContentLayout title="Resources">
      <div className="space-y-8">
              ...
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    ...
                    <a href="/submission/rashad-khalifa">
                      Dr. Rashad Khalifa, Ph.D.
                    </a>
                  </CardDescription>
                </CardHeader>
                <CardContent className="space-y-2">
                  <div className="space-y-1">
                    <a
                      href="https://docs.wikisubmission.org/library/books/quran-the-final-testament"
                      target="_blank"
                      className="block p-2"
                    >
                      English →
                    ...
                    <a
                      href="https://docs.wikisubmission.org/library/books/quran-the-final-testament-turkish"
                      target="_blank"
                      className="block p-2"
                    >
                      Turkish →
                    ...
                    <a
                      href="https://docs.wikisubmission.org/library/books/quran-the-final-testament-french"
                      target="_blank"
                      className="block p-2"
                    >
                      French →
                    ...
                    <a
                      href="https://docs.wikisubmission.org/library/books/quran-the-final-testament-persian"
                      target="_blank"
                      className="block p-2"
                    >
                      Persian →
                    ...
                    <a
                      href="https://docs.wikisubmission.org/library/books/quran-the-final-testament-tamil"
                      target="_blank"
                      className="block p-2"
                    >
                      Tamil →
                    ...
                    <a
                      href="https://docs.wikisubmission.org/library/books/quran-the-final-testament-hindi"
                      target="_blank"
                      className="block p-2"
                    >
                      Hindi →
                    ...
                    <a
                      href="https://docs.wikisubmission.org/library/books/quran-the-final-testament-with-arabic"
                      target="_blank"
                      className="block p-2"
                    >
                      Arabic (with English) →
            ...
            <TabsContent value="appendices">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    From the original translation, the{" "}
                    <a href="/submission/appendices">38 Appendices</a> cover
                    many key topics in Submission.
                  </CardDescription>
                </CardHeader>
                <CardContent className="space-y-2">
                  <div className="space-y-1">
                    <a
                      href="https://docs.wikisubmission.org/library/books/quran-the-final-testament-appendices"
                      target="_blank"
                      className="block p-2"
                    >
                      English →
                    ...
                    <a
                      href="https://docs.wikisubmission.org/library/books/quran-the-final-testament-appendices-turkish"
                      target="_blank"
                      className="block p-2"
                    >
                      Turkish →
                    ...
                    <a
                      href="https://docs.wikisubmission.org/library/books/quran-the-final-testament-appendices-french"
                      target="_blank"
                      className="block p-2"
                    >
                      French →
                    ...
                    <a
                      href="https://docs.wikisubmission.org/library/books/quran-the-final-testament-appendices-persian"
                      target="_blank"
                      className="block p-2"
                    >
                      Persian →
                    ...
                    <a
                      href="https://docs.wikisubmission.org/library/books/quran-the-final-testament-appendices-tamil"
                      target="_blank"
                      className="block p-2"
                    >
                      Tamil →
                    ...
                    <a
                      href="https://docs.wikisubmission.org/library/books/quran-the-final-testament-appendices-hindi"
                      target="_blank"
                      className="block p-2"
                    >
                      Hindi →
        ...
        <section className="space-y-4">
          ...
          <br />
          <a
            href="https://docs.wikisubmission.org/library/books/visual-presentation-of-the-miracle"
            target="_blank"
          >
        ...
        <section className="space-y-4 mb-8">
          <div className="md:flex items-center gap-3 space-y-4">
            ...
            <div className="flex flex-col">
              <h3 className="text-3xl font-semibold">
                The Computer Speaks: God&aposs Message to The World
              </h3>
              <span className="text-md font-light text-slate-800 dark:text-slate-200">
                Dr. Rashad Khalifa, Ph.D.
              </span>
