    ...
    return (
        <ContentLayout title="Appendices">
            <div className="space-y-4">
                <Link href="https://wikisubmission.org/appendices" target='_blank' rel="noreferrer">
                ...
                <section className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    {Data.DataAppendices.map((d) => {
                        return (
                            <Link href={`https://wikisubmission.org/appendix/${d.appendix_number}`} target="_blank" key={`appendix-${d.appendix_number}`}>
