...
export default function ContextButton({ verse, type }: { verse: WQuranVerse, type: WResult["request"]["type"] }) {
    if (type === "verse" || type === "verse_range" || type === "search" || type === "multiple_verses") {
        return (
