...
import { Calendar, Clock, BookOpen, ChevronRight, ArrowLeft } from "lucide-react";
      ...
      >
        <CardHeader className="border-b border-border p-3 dark:border-white/10 sm:p-6">
          <div className="flex items-center gap-2 sm:gap-3">
            ...
            <h2 className="text-lg font-semibold text-foreground sm:text-2xl">Bookmarked Verses</h2>
