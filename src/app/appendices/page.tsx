...
export default function QuranPage() {
    return (
        <main className="space-y-4">
            <h1 className="text-3xl font-light text-primary">From <strong className={Fonts.wiki.className}>Quran: The Final Testament</strong></h1>
            <div className="flex flex-wrap gap-2 justify-between">
                <section className="flex gap-2">
                    <Link href="https://library.wikisubmission.org/file/quran-the-final-testament-appendices" target="_blank">
